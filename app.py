...
login_manager = LoginManager() #criando instancia dessa classe 
db.init_app(app)
login_manager.init_app(app) #iniciando o login manager 

#a view login que vai ser utilizada para redirecionar o usuario quando ele nao estiver logado
...
def login(): #recuperar o que o usuário enviou
    data = request.json
